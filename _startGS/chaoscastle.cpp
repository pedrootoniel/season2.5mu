...
{
    OBJECTSTRUCT* lpObj01 = (OBJECTSTRUCT*)GS_GOBJPOINTER(iChaosCastleIndex);
	OBJECTSTRUCT* lpObj02 = (OBJECTSTRUCT*)GS_GOBJPOINTER(iWinnerIndex);

	if(gObjIsConnected(lpObj02->m_Index) == 0)
	{
	  return;
	}
